...
#define CLOCK_SPEED (16000000ul)                //16*(1000000)
#define CLOCK_TIME_MS (16000ul)                 //CLOCK_SPEED/1000
#elif(CLOCK_SPEED_MHz==1)
#define CLOCK_SPEED (1000000ul)                 //1000000
#define CLOCK_TIME_MS (1000ul)                  //CLOCK_SPEED/1000
#endif
